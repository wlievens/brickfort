...
part_sizes[part_portcullis_1x8x12] = (  1,  8, 36 )
		...
		for y in range(size):
			for x in range(size):
				...
				if cell == Cell.WINDOW:
					...
					if check_top_corner(matrix, next, x, y):
						...
						for d in range(min_size):
							...
							for z in range(layer - layers + 1, layer):
								emit_part(f, color_red, part_brick_1x1, sx, sy, z * 3, 0)
								emit_part(f, color_lime, part_brick_1x1, fx, fy, z * 3, 0)
							if max_size == 6:
				...
				if cell == Cell.PORTCULLIS:
					...
					if check_top_corner(matrix, next, x, y):
						(width, height, layers) = scan_cells_down(x, y, layer)
						if width == 1 and height == 8 and layers == 12:
							emit_part(f, color_dark_bley, part_portcullis_1x8x12, sx, sy, (layer - 12) * 3, 0)
...

...

